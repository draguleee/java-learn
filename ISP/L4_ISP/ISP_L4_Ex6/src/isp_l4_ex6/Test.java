 ...
 * Exercitiul 6
 * 
 * Clasa de test pentru clasele anterior create.
 */
...
public class Test {
	...
	public static void main(String[] args) {
		...
		// Crearea obiectelor de clasa Shape
		Shape s1 = new Shape();
		...
		/* TESTAREA CLASEI SHAPE */
		System.out.println("----------------------------------------------------------");
		System.out.println("CLASA SHAPE");
		System.out.println("----------------------------------------------------------");
		
		System.out.println();
		System.out.println("FORMA S1");
		System.out.println("Culoarea formei s1 inainte de schimbare: " + s1.getColor());
		s1.setColor("white");
		System.out.println("Culoarea formei s1 dupa schimbare: " + s1.getColor());
		System.out.println("Status umplere s1: " + s1.isFilled());
		s1.setFilled(false);
		System.out.println("Status umplere s1 dupa modificare: " + s1.isFilled());
		System.out.println(s1.toString());
		
		System.out.println();
		System.out.println("FORMA S2");
		System.out.println("Culoarea formei s2 inainte de schimbare: " + s2.getColor());
		s2.setColor("violet");
		System.out.println("Culoarea formei s2 dupa schimbare: " + s2.getColor());
		System.out.println("Status umplere s2: " + s2.isFilled());
		s2.setFilled(false);
		System.out.println("Status umplere s2 dupa modificare: " + s2.isFilled());
